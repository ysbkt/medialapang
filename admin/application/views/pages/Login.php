...
<div class="container">
  <div class="info">
    ...
    <span>Made with <i class="fa fa-heart"></i> by <a href="http://medialapang.com" target="_blank">Media Lapang</a></span>
  </div>
</div>
<div class="form">
  <div class="thumbnail"><img src="<?php echo base_url(); ?>../assets/img/icon.png" /></div>
  ...
  <form class="login-form" method="post" action="<?php echo base_url('Login/LoginCheck') ?>">
