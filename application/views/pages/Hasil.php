        ...
        <div class="col-md-12">
          ...
          <!-- <div class="side-search"> -->
            <div class="col-md-4" id="side-menu">
              <form action="<?php echo base_url('Lapangan/Search'); ?>" role="search" method="get">
                <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="box">
                  <div class="row">
                    <div class="col-md-8">
                      <img src="<?php echo base_url().'assets/gambar_lapangan/'.$data->gambar ?>" style="min-width: 100%; max-height: 300px;" class="image-responsive">
                    </div>
                    <div class="col-md-4">
                      <div class="row">
                ...
                <hr>
                <?php } }else{ echo "Lapangan Tidak Ditemukan"; }?>
